 ...
 * @author mzechner
 * @author Nathan Sweet */
public class ScrollPane2 extends WidgetGroup {
	...
	public ScrollPane2 (@Null Actor actor) {
		this(actor, new ScrollPaneStyle());
	}

	/** @param actor May be null. */
	public ScrollPane2 (@Null Actor actor, Skin skin) {
		this(actor, skin.get(ScrollPaneStyle.class));
	}

	/** @param actor May be null. */
	public ScrollPane2 (@Null Actor actor, Skin skin, String styleName) {
		this(actor, skin.get(styleName, ScrollPaneStyle.class));
	}

	/** @param actor May be null. */
	public ScrollPane2 (@Null Actor actor, ScrollPaneStyle style) {
	...
	protected void addCaptureListener () {
		addCaptureListener(new InputListener() {
			...
			public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
				...
				if (getStage() != null) getStage().setScrollFocus(ScrollPane2.this);
		...
		return new ActorGestureListener() {
			...
			public void fling (InputEvent event, float x, float y, int button) {
				...
				if (velocityX != 0 || velocityY != 0) {
					...
					ScrollPane2.this.fling(flingTime, velocityX, velocityY);
				}
			}
